...
from codenerix_invoicing.models_sales import SalesLines, SalesBasket, SalesOrder, SalesTicket, SalesAlbaran, SalesInvoice
...
class Command(BaseCommand, Debugger):
    ...
    def handle(self, *args, **options):
        ...
        for m in [SalesLines, SalesBasket, SalesOrder, SalesTicket, SalesAlbaran, SalesInvoice]:
